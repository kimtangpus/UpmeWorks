...
<body>
  ...
  <nav class="navbar">
    <div class="container-fluid">
      <a class="navbar-brand"><img src="images/UPmePRO_Revised-removebg-preview.png" alt="logo" class="img-fluid"
          style="width: 150px;"></a>
    ...
    <div class="row my-5 pb-5 justify-content-center">
      ...
      <div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
        <div class="card" style="background-color: #cce3cc;">
          <img src="images/sample.jpg" class="card-img-top" alt="Gallery Image">
          <div class="card-body">
