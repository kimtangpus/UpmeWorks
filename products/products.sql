...
INSERT INTO `products` (`id`, `rank`, `name`, `image_url`, `total_buyers`, `price`, `stock`, `rating_score`, `rating_percentage`, `status`) VALUES
(1, 1, 'Sweater', '', 12990, 1234.82, 231, 'Perfect', 10, 'Archived'),
(2, 2, 'Givenchy Sweater', '', 12990, 1234.82, 0, 'Very Good', 80, 'Archived'),
